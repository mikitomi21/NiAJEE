...
@DeclareRoles({EmployeeRoles.ADMIN, EmployeeRoles.USER})
@RunAs(EmployeeRoles.ADMIN)
@Log
...
//    }
    ...
    @SneakyThrows
    private void init() {
        if (employeeService.find("Jakub").isEmpty()){
            Employee emp1 = Employee.builder()
                    ...
                    .password("siema")
                    .lastLoginDateTime(LocalDateTime.now().minusYears(2))
            ...
            Employee emp2 = Employee.builder()
                    ...
                    .password("siema")
                    .lastLoginDateTime(LocalDateTime.now().minusYears(2))
                    .roles(List.of(EmployeeRoles.USER))
                    .build();
