...
import com.company.hightechcomapny.employee.model.function.EmployeesToModelFunction;
...
//    }
    ...
    public EmployeesToModelFunction employeesToModel() {
        return new EmployeesToModelFunction();
    }
}
